# Safety helmet model providing trained model files (pt format) process files and verification.

# Body

Safety helmet model, provide the trained model file (pt format), process file and verification image
Provide the corresponding training dataset of 12000 pieces, suitable for learning research and graduation project
